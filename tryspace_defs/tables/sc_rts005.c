...
SC_RtsTable005_t SC_Rts005 = 
{
    ...
    .rts.cmd2.CommandHeader = CFE_MSG_CMD_HDR_INIT(LC_CMD_MID, SC_MEMBER_SIZE(cmd2), LC_RESET_AP_STATS_CC, 0x00),
    .rts.cmd2.Payload.APNumber = 5,
    .rts.cmd2.Payload.Padding = 0x00,
};
